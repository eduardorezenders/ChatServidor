...
namespace CRM.CHATSERVER
{
    ...
    public class CHATSERVER
    {
        ...
        public static Hashtable htConexoes = new Hashtable(300); // 30 usuários é o limite definido
        ...
        public CHATSERVER(IPAddress endereco, int porta)
        {
            enderecoIP = endereco;
            _porta = porta;
        }
        ...
        public static void IncluiUsuario(TcpClient tcpUsuario, string strUsername)
        {
            ...
            CHATSERVER.htUsuarios.Add(strUsername, tcpUsuario);
            CHATSERVER.htConexoes.Add(tcpUsuario, strUsername);
        ...
        public void IniciaAtendimento(bool iniciar = true)
        {
            try
            {
                ...
                tlsCliente = new TcpListener(ipaLocal, _porta);
    ...
    public class Conexao
    {
        ...
        private void AceitaCliente()
        {
            ...
            if (usuarioAtual != "")
            {
                ...
                if (CHATSERVER.htUsuarios.Contains(usuarioAtual) == true)
                {
                ...
                else
                {
                    ...
                    CHATSERVER.IncluiUsuario(tcpCliente, usuarioAtual);
                }
            }
            else
            {
            ...
            try
            {
                ...
                while ((strResposta = srReceptor.ReadLine()) != "")
                {
                    ...
                    else
                    {
                        ...
                        CHATSERVER.EnviaMensagem(usuarioAtual, strResposta);
                    }
                }
            }
            catch
